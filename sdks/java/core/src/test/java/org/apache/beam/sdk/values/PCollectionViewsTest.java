...
import static org.apache.beam.sdk.values.PCollectionViews.ListViewFn.computeOverlappingRanges;
import static org.apache.beam.sdk.values.PCollectionViews.ListViewFn.computePositionForIndex;
import static org.apache.beam.sdk.values.PCollectionViews.ListViewFn.computeTotalNumElements;
...
public class PCollectionViewsTest {
  ...
  public void testNoOverlapping() {
    ...
    assertPositions(ranges, nonOverlappingRangesToNumElementsPerPosition);
  }
